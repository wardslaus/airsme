...
import com.airsme.fragments.fragment_bookings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(
                        ...
                        new PrimaryDrawerItem().withName("Bookings").withIcon(FontAwesome.Icon.faw_briefcase).withIdentifier(1)
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem != null) {
                            ...
                            if (drawerItem.getIdentifier() == 10000) {
                                ...
                                frag = fragment_bookings.newInstance("Demo");
                                getSupportFragmentManager().beginTransaction().replace(R.id.frame_container, frag).commit();
